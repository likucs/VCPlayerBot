...
async def start(client, message):
    ...
    buttons = [
        [
            ...
            InlineKeyboardButton('🧩 Source', url='https://github.com/likucs/VCPlayerBot')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://github.com/likucs/VCPlayerBot'),
            InlineKeyboardButton('Owner 👑', url='https://t.me/iAmLiKu1'),     
        ],
        [
            InlineKeyboardButton("🎞 How to Deploy Contact", url='https://t.me/iAmLiKu1'),
            InlineKeyboardButton('🗑 Close', callback_data='close'),
        ]
    ]
